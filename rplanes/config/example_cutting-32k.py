config = {
    ...
    'expname': 'endonerf_32k',
    'logdir': './exps/endonerf_cutting_tissues_twice_32k_1',
    'device': 'cuda:0',

    'data_downsample': 1.0,
    'data_dirs': ['/data/RPlane/RPlane/Rplanes/data/endonerf_full_datasets/cutting_tissues_twice'],
    'contract': False,
    'ndc': True,
    'ndc_far': 1.2,
    'isg': True,
